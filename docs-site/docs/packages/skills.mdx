---
title: Skills
description: Pre-configured behavior bundles that teach the AI how to do specific
sidebar:
  label: Skills
  order: 2
---
...
Pre-configured behavior bundles that teach the AI how to do specific
 ...
 The AI agent can install skills for itself and use them automatically when relevant.
