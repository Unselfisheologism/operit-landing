  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans antialiased">
      <ComparisonPage
        ...
        verdict="Nebula.gg is a great new mobile AI assistant with good UI. twent AI provides full Ubuntu terminal, local GGUF model support, MCP plugins and root automation that Nebula does not offer."
        metaKeywords="nebula.gg ai, mobile chat assistant, emotional support ai, conversation app android, friendly ai bot"
        features={[
