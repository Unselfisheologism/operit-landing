...
export function FinalCTA() {
  ...
  return (
    <section className="relative py-24 sm:py-32 px-6 overflow-hidden bg-zinc-100 dark:bg-zinc-900">
      ...
      <div
        ref={ref}
        className={`relative z-10 max-w-4xl mx-auto text-center transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
      >
        ...
        <div className="mb-10 max-w-2xl mx-auto">
          <blockquote className="text-base text-zinc-600 dark:text-zinc-400 italic leading-relaxed mb-3">
            &ldquo;I automated my entire morning routine — weather, emails,
            calendar summary — saving 45 min/day. That&apos;s 22 hours a month I
            got back.&rdquo;
          </blockquote>
          <div className="text-sm font-display text-zinc-900 dark:text-zinc-100">
        ...
        <div className="flex flex-col items-center gap-6">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-12 py-5 bg-blue-600 text-white font-secondary text-xl uppercase tracking-wider hover:bg-blue-500 transition-colors"
          >
            Download Twent
          </a>
          <div className="flex items-center gap-3">
            ...
            <SocialLinksInline className="gap-3" />
          </div>
        </div>
      </div>
    </section>
