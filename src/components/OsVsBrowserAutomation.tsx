...
export function OsVsBrowserAutomation({ dark }: { dark: boolean }) {
      ...
      <main>
        ...
        >
          <div className="prose prose-zinc dark:prose-invert max-w-none">
            ...
            <h2 id="the-problem" className="font-display text-2xl md:text-3xl text-zinc-900 dark:text-zinc-100 tracking-tight mb-6 scroll-mt-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              {[
                { num: "01", title: "Prompt Injection", desc: "Hidden instructions in web pages that hijack the AI's behavior" },
                { num: "02", title: "Cross-Tab Leakage", desc: "Agentic AI sees all open tabs — one compromised page leaks everything" },
                { num: "03", title: "Data Harvesting", desc: "AI browsers memorize your sessions, creating a single point of failure" },
              ].map((item) => (
                <div
                  key={item.num}
            ...
            <h2 id="prompt-injection" className="font-display text-2xl md:text-3xl text-zinc-900 dark:text-zinc-100 tracking-tight mb-6 scroll-mt-32">
            ...
            <div className="bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 p-6 mb-8">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                <strong className="text-zinc-900 dark:text-zinc-100">ChatGPT Atlas (100% success rate):</strong>{" "}
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                <strong className="text-zinc-900 dark:text-zinc-100">CometJacking (LayerX):</strong>{" "}
            ...
            <p className="text-base leading-relaxed mb-6">The attack vectors are diverse and hard to defend against:</p>

            <ul className="space-y-3 mb-8 text-sm text-zinc-600 dark:text-zinc-400">
              <li className="flex items-start gap-3"><span className="text-red-500 mt-1 shrink-0">✗</span><span><strong>Hidden HTML:</strong> <code className="text-xs bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5">&lt;p style="opacity:0"&gt;</code> — invisible to humans, parsed by the AI</span></li>
              <li className="flex items-start gap-3"><span className="text-red-500 mt-1 shrink-0">✗</span><span><strong>Image alt text:</strong> <code className="text-xs bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5">&lt;img alt="ignore previous instructions..."&gt;</code> — hidden in metadata the AI reads</span></li>
              <li className="flex items-start gap-3"><span className="text-red-500 mt-1 shrink-0">✗</span><span><strong>Image steganography:</strong> Text embedded in images via color combinations — invisible to humans, readable by OCR</span></li>
              <li className="flex items-start gap-3"><span className="text-red-500 mt-1 shrink-0">✗</span><span><strong>URL query injection:</strong> Malicious commands in URL parameters that execute when the AI processes the link</span></li>
            </ul>

            <h2 id="cross-tab-leakage" className="font-display text-2xl md:text-3xl text-zinc-900 dark:text-zinc-100 tracking-tight mb-6 scroll-mt-32">
            ...
            <p className="text-base leading-relaxed mb-6">
              ...
              tabs. This means a single successful prompt injection on <em>any</em>{" "}
              tab can cascade across your entire browsing session — reading your
              email, your bank, your social media, and performing actions across
              all of them.
            </p>

            <p className="text-base leading-relaxed mb-8">
              Security researchers at Anthropic have acknowledged that prompt
              injection is a legitimate, unsolved problem for AI-powered,
              agentic browsers. There is no reliable defense today.
            </p>

            <h2 id="data-harvesting" className="font-display text-2xl md:text-3xl text-zinc-900 dark:text-zinc-100 tracking-tight mb-6 scroll-mt-32">
            ...
            <p className="text-base leading-relaxed mb-8">
              ...
              give up your current session — it gives up <em>everything it has learned about you</em>.
              Attackers no longer need to phish you directly. They just need to
              trick the AI, which is far easier because the AI can't reliably
              tell who it's talking to.
            </p>

            <h2 id="os-level-different" className="font-display text-2xl md:text-3xl text-zinc-900 dark:text-zinc-100 tracking-tight mb-6 scroll-mt-32">
            ...
            <p className="text-base leading-relaxed mb-6">Here's why this matters for each of the three risks:</p>

            <div className="space-y-4 mb-8">
              <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 p-5">
                <p className="font-display text-base text-zinc-900 dark:text-zinc-100 mb-2">✓ Prompt Injection — Eliminated</p>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 p-5">
                <p className="font-display text-base text-zinc-900 dark:text-zinc-100 mb-2">✓ Cross-Tab Leakage — Not Applicable</p>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 p-5">
                <p className="font-display text-base text-zinc-900 dark:text-zinc-100 mb-2">✓ Data Harvesting — Minimized by Design</p>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            <h2 id="twent-approach" className="font-display text-2xl md:text-3xl text-zinc-900 dark:text-zinc-100 tracking-tight mb-6 scroll-mt-32">
              How Twent does it
            </h2>
            ...
            <p className="text-base leading-relaxed mb-6">Key architectural differences from browser-level tools:</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              {[
                { feature: "Execution layer", browser: "Browser DOM / Playwright / CDP", os: "Android Accessibility Services + Shell" },
                { feature: "AI model", browser: "Cloud API (OpenAI, Anthropic)", os: "Local GGUF/MNN models (on-device)" },
                { feature: "Data flow", browser: "User → Cloud → Browser → Web", os: "User → Device → App (never leaves phone)" },
                { feature: "Prompt injection surface", browser: "Every HTML element, URL, image", os: "No web DOM to inject into" },
                { feature: "Cross-app isolation", browser: "None — AI sees all tabs", os: "OS sandbox — each app is isolated" },
                { feature: "Internet required", browser: "Always (cloud AI)", os: "Optional (local models work offline)" },
              ].map((row) => (
                <div
                  key={row.feature}
                ...
                >
                  ...
                  <div className="flex items-start gap-2 mb-1">
                    ...
                    <span className="text-xs text-zinc-500 dark:text-zinc-400 line-through">{row.browser}</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-500 text-xs mt-0.5">✓</span>
                    <span className="text-xs text-zinc-700 dark:text-zinc-300 font-medium">{row.os}</span>
                  </div>
                </div>
              ))}
            </div>

            <h2 id="comparison" className="font-display text-2xl md:text-3xl text-zinc-900 dark:text-zinc-100 tracking-tight mb-6 scroll-mt-32">
              ...
              <table className="w-full text-sm border border-zinc-200 dark:border-zinc-800">
                <thead>
                  <tr className="bg-zinc-50 dark:bg-zinc-900/50">
                    <th className="text-left p-3 font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400 border-b border-zinc-200 dark:border-zinc-800">Risk</th>
                    <th className="text-left p-3 font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400 border-b border-zinc-200 dark:border-zinc-800">Browser (Comet, Atlas, browser-use, aside)</th>
                    <th className="text-left p-3 font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400 border-b border-zinc-200 dark:border-zinc-800">OS-Level (Twent)</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { risk: "Prompt injection", browser: "High — any web content can inject instructions", os: "None — no web DOM to inject into" },
                    { risk: "Cross-tab leakage", browser: "High — AI sees all open tabs", os: "None — apps sandboxed by OS" },
                    { risk: "Data harvesting", browser: "High — builds browsing profiles in the cloud", os: "None — processes locally, no cloud profile" },
                    { risk: "Antivirus protection", browser: "Useless against prompt injection", os: "Not needed — no web attack surface" },
                    { risk: "Offline capability", browser: "None — requires cloud AI + internet", os: "Full — local GGUF models work offline" },
                    { risk: "Account safety", browser: "Compromised if AI is tricked", os: "Agent interacts via OS APIs, not browser auth" },
                  ].map((row) => (
                    <tr key={row.risk} className="border-b border-zinc-200 dark:border-zinc-800 last:border-b-0">
                      <td className="p-3 text-zinc-900 dark:text-zinc-100 font-medium">{row.risk}</td>
                      <td className="p-3 text-zinc-500 dark:text-zinc-400">{row.browser}</td>
                      <td className="p-3 text-green-600 dark:text-green-400 font-medium">{row.os}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-6 mb-8">
              <h2 id="tldr" className="font-display text-xl text-zinc-900 dark:text-zinc-100 mb-4 scroll-mt-32">TL;DR</h2>
              <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
                <li>• Browser-level AI automation is fundamentally unsafe — prompt injection, cross-tab leakage, and data harvesting are unsolved problems</li>
                <li>• OS-level automation operates at the system layer — no browser DOM, no tab context, no web-based attack surface</li>
                <li>• Prompt injection is impossible when the AI doesn't read HTML</li>
                <li>• Cross-tab leakage is impossible when apps are sandboxed by the OS</li>
                <li>• Data stays on-device with local models — no cloud profile to compromise</li>
                <li>• Twent: free, on-device, works offline, no cloud dependency</li>
              </ul>
            </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="border-b border-zinc-200 dark:border-zinc-800 pb-6">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  ...
                  APIs where the content is controlled by the OS and installed apps,
                  not by unknown web servers.
                </p>
              </div>
              ...
              <div className="border-b border-zinc-200 dark:border-zinc-800 pb-6">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  ...
                  frameworks that drive a browser programmatically. They're not
                  AI browsers themselves, but they share the same fundamental
                  limitation: the automation happens inside the browser DOM,
                  where web content can inject malicious instructions.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  ...
                  the three specific risks discussed in this article. But it
                  introduces different considerations — like the security of the
                  accessibility services layer itself, which is controlled by
                  Android's OS security model. The key difference is that the
                  attack surface is the operating system, not the open web.
                </p>
              </div>
            </div>
          </div>
