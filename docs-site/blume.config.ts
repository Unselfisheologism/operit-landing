...
export default defineConfig({
  ...
  redirects: [
    ...
    { from: "/tools/overview", to: "/features/agent-capabilities", status: 301 },
    { from: "/tools/mcp", to: "/plugins/mcp", status: 301 },
    { from: "/more/toolbox", to: "/", status: 301 },
    { from: "/more/tool-reference", to: "/features/agent-capabilities", status: 301 },
